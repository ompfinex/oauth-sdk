export namespace OMPFinex {
  ...
  class OMPFinexAuth {
    ...
    private resolveAuthentication!: (value: AuthResponse | PromiseLike<AuthResponse>) => void;
    private rejectAuthentication!: (reason?: any) => void;
    private OAUTH2_URL: string;
    ...
    authenticate(): Promise<AuthResponse | AuthError> {
  ...
  export function authenticate(applicationId: string): Promise<AuthResponse | AuthError> {
